...
getwd()
# [1] "/Users/Primahadi/Documents/research/2020-11-03-PARALLEL-CORPUS-PUPS" <- my working directory/folder. The output files from this process will be saved in this current directory/folder in our computer (the directory will be different in each computer for each user of this script)

# load into R the Eng-Idn OpenSubtitles corpus in .tmx format
tmx <- readr::read_lines(file = "~/Downloads/en-id-OpenSubtitles.tmx")
# The code in line 12 above shows that I put the corpus file in my "Downloads" directory/folder.
